...
document.addEventListener('DOMContentLoaded', () => {
	const teachers = [
		...
		{ photo: 'assets/images/teacher-15.jpg', name: 'Олеся', role: 'Русский язык и чтение', desc: 'Важно не менять ребенка, а  создать условия, в которых ученики раскрываются, будут учиться с интересом и расти с уверенностью. Мы видим в ребёнке личность, а не только ученика.' },	
	];
